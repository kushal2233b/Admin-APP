    ...
    <div className="space-y-6 animate-in fade-in pb-16 md:pb-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 p-4 rounded-2xl bg-gradient-to-r from-purple-900/80 via-indigo-950/80 to-purple-950 border border-[#29252A] shadow-xl">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-[#B0ACB0] font-semibold">Live Gaming Platform</span>
          </div>
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          ...
          <button
            ...
            className="flex-1 sm:flex-none flex items-center justify-center gap-1.5 px-3.5 py-2.5 rounded-xl font-semibold text-xs bg-[#1B181C] hover:bg-[#FF3048]/80 border border-[#29252A] text-[#B0ACB0] transition active:scale-95"
          >
            <Bell className="w-4 h-4 text-[#C9A34E]" />
            <span>Announce</span>
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3.5">
        ...
        <div
          ...
          className="p-4 rounded-2xl bg-[#0D0B0D] border border-[#29252A] hover:border-amber-400/50 transition cursor-pointer group flex flex-col justify-between"
        >
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-bold text-[#B0ACB0] uppercase">Total Users</span>
            <div className="p-2 rounded-xl bg-[#141215]/50 text-[#C9A34E] group-hover:scale-110 transition">
              <Users className="w-4 h-4" />
            </div>
          </div>
          <div className="mt-3">
            <p className="text-2xl font-black text-white">{totalUsersCount}</p>
            <p className="text-[10px] text-[#777278] mt-0.5">Registered Players</p>
          </div>
        </div>
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-bold text-[#B0ACB0] uppercase">Active Users</span>
            <div className="p-2 rounded-xl bg-[#350A12] text-[#C9A34E] group-hover:scale-110 transition">
              <UserCheck className="w-4 h-4" />
            </div>
          </div>
          <div className="mt-3">
            <p className="text-2xl font-black text-[#C9A34E]">{activeUsersCount}</p>
            <p className="text-[10px] text-[#C9A34E]/80 mt-0.5">Active Account Status</p>
          </div>
        </div>
        ...
        <div
          ...
          className="p-4 rounded-2xl bg-[#0D0B0D] border border-[#C9A34E]/30 hover:border-amber-400 transition cursor-pointer group flex flex-col justify-between"
        >
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-bold text-[#C9A34E] uppercase">Pending Deposits</span>
            <div className="p-2 rounded-xl bg-[#C9A34E]/20 text-[#C9A34E] group-hover:scale-110 transition">
              <ArrowDownRight className="w-4 h-4" />
            </div>
          </div>
          <div className="mt-3">
            <p className="text-2xl font-black text-[#C9A34E]">{pendingDeposits.length}</p>
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-bold text-[#B0ACB0] uppercase">Pending Withdrawals</span>
            <div className="p-2 rounded-xl bg-[#350A12]/50 text-[#B0ACB0] group-hover:scale-110 transition">
              <ArrowUpRight className="w-4 h-4" />
            </div>
          </div>
          <div className="mt-3">
            <p className="text-2xl font-black text-white">{pendingWithdrawals.length}</p>
            <p className="text-[10px] text-[#B0ACB0]/80 mt-0.5">₹{pendingWithdrawalsSum} Payout Sum</p>
          </div>
        </div>
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-bold text-[#B0ACB0] uppercase">Live Matches</span>
            <div className="p-2 rounded-xl bg-[#141215]/50 text-rose-400 group-hover:scale-110 transition">
              <Flame className="w-4 h-4" />
            </div>
          </div>
          <div className="mt-3">
            <p className="text-2xl font-black text-rose-400">{liveMatches.length}</p>
            <p className="text-[10px] text-[#B0ACB0]/80 mt-0.5">Matches In-Progress</p>
          </div>
        </div>
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-bold text-[#B0ACB0] uppercase">Upcoming</span>
            <div className="p-2 rounded-xl bg-[#141215]/50 text-[#C9A34E] group-hover:scale-110 transition">
              <Calendar className="w-4 h-4" />
            </div>
          </div>
          <div className="mt-3">
            <p className="text-2xl font-black text-[#C9A34E]">{upcomingMatches.length}</p>
            <p className="text-[10px] text-[#B0ACB0]/80 mt-0.5">Scheduled Lobbies</p>
          </div>
        </div>
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-bold text-[#B0ACB0] uppercase">Completed</span>
            <div className="p-2 rounded-xl bg-[#141215]/50 text-[#C9A34E] group-hover:scale-110 transition">
              <CheckCircle2 className="w-4 h-4" />
            </div>
          </div>
          <div className="mt-3">
            <p className="text-2xl font-black text-[#C9A34E]">{completedMatches.length}</p>
            <p className="text-[10px] text-[#B0ACB0]/80 mt-0.5">Results Released</p>
          </div>
        </div>
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-bold text-[#B0ACB0] uppercase">Total Revenue</span>
            <div className="p-2 rounded-xl bg-[#350A12] text-[#C9A34E] group-hover:scale-110 transition">
              <TrendingUp className="w-4 h-4" />
            </div>
          </div>
          <div className="mt-3">
            <p className="text-2xl font-black text-[#C9A34E]">₹{(totalRevenue ?? 0).toLocaleString('en-IN')}</p>
            <p className="text-[10px] text-[#C9A34E]/80 mt-0.5">Net Platform Revenue</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        {/* Recent Deposits */}
        <div className="p-4 rounded-2xl bg-[#0D0B0D] border border-[#29252A] space-y-3">
          <div className="flex items-center justify-between pb-2 border-b border-[#29252A]">
            <h3 className="font-extrabold text-sm text-white flex items-center gap-2">
              <ArrowDownRight className="w-4 h-4 text-[#C9A34E]" /> Recent Deposits
            </h3>
            <button
              onClick={() => setActiveTab('deposits')}
              className="text-[11px] text-[#C9A34E] font-bold hover:underline"
            >
              View All
            </button>
          </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-right">
                      <span className="font-extrabold text-[#C9A34E] text-sm">+₹{tx.amount}</span>
                      <span
        ...
        <div className="p-4 rounded-2xl bg-[#0D0B0D] border border-[#29252A] space-y-3">
          <div className="flex items-center justify-between pb-2 border-b border-[#29252A]">
            <h3 className="font-extrabold text-sm text-white flex items-center gap-2">
              <ArrowUpRight className="w-4 h-4 text-[#C9A34E]" /> Recent Withdrawals
            </h3>
            <button
              onClick={() => setActiveTab('withdrawals')}
              className="text-[11px] text-[#C9A34E] font-bold hover:underline"
        ...
        <div className="p-4 rounded-2xl bg-[#0D0B0D] border border-[#29252A] space-y-3">
          <div className="flex items-center justify-between pb-2 border-b border-[#29252A]">
            <h3 className="font-extrabold text-sm text-white flex items-center gap-2">
              <Trophy className="w-4 h-4 text-[#777278]" /> Match Registrations
            </h3>
            <button
              onClick={() => setActiveTab('matches')}
              className="text-[11px] text-[#C9A34E] font-bold hover:underline"
          ...
          <div className="space-y-2">
            {recentRegistrations.length === 0 ? (
              <p className="text-xs text-[#777278] text-center py-6">No match registrations yet.</p>
            ) : (
                  ...
                  <div>
                    <p className="text-xs font-extrabold text-white">
                      ...
                      {reg.inGameName && reg.inGameName !== 'N/A' && reg.inGameName !== reg.username ? (
                        <span className="text-[11px] text-[#B0ACB0] font-normal ml-1">({reg.inGameName})</span>
                      ) : null}
                    </p>
                    <p className="text-[10px] text-[#B0ACB0] truncate max-w-[180px]">
                      {reg.tournamentTitle}
                    </p>
                  </div>
                  <div className="text-right">
                    <span className="px-2 py-0.5 text-[9px] font-extrabold bg-[#141215] text-[#C9A34E] rounded">
                      Fee: ₹{reg.entryFee}
                    </span>
                  </div>
                </div>
